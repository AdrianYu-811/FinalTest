...
//        textView = findViewById(R.id.textView);
        ...
        try {
            button.setOnClickListener(new View.OnClickListener() {
                Mat img = Utils.loadResource(MainActivity.this, R.drawable.qrcode, CvType.CV_8UC4);
                Mat result = Utils.loadResource(MainActivity.this, R.drawable.rectangle, CvType.CV_8UC4);
                ...
                public void onClick(View v) {
                    try {
                        Bitmap bitmap=Bitmap.createBitmap(img.width(),img.height(), Bitmap.Config.ARGB_8888);
                        Bitmap bresult = Bitmap.createBitmap(result.width(),result.height(), Bitmap.Config.ARGB_8888);
                        ImageView imageView = findViewById(R.id.imageView);
...
//                            Log.d("adrian","point"+b);
                            ...
                            String [] xy = a.split(",",-1);
                                ...
                                if(firstpoint.x !=0 && secondpoint.x!=0 && secondpoint.y != 0 && firstpoint.y!=0)
                                    Imgproc.line(result,firstpoint,secondpoint,linecolor,linnewidth);
//                            count2++;
//                            if (count2==2)
//                                break;

                        }
                        Utils.matToBitmap(result,bresult);
                        imageView2.setImageBitmap(bresult);
                    }
                    catch (Exception e){
                        e.printStackTrace();
                    }
